...
//   2. las migraciones 0001-0009 se aplican vía el runner TS
...
describe("contrato del core + migraciones (Drizzle/TS)", () => {
  ...
  it("aplica 0001-0009 vía el runner TS (2 pasadas, la 2ª es no-op)", async () => {
    ...
    expect(first.applied).toEqual([
      ...
      "0008_media_link_claims", "0009_media_link_constraints",
    ]);
  ...
  it("un kind de 0004 (missing_url) es rechazado tras el rollback completo, y el diff de public sigue vacío", async () => {
    ...
    expect(result.reverted).toEqual([
      "0009_media_link_constraints", "0008_media_link_claims",
