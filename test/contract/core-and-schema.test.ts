...
//   2. las migraciones 0001-0020 se aplican vía el runner TS
...
describe("contrato del core + migraciones (Drizzle/TS)", () => {
  ...
  it("aplica 0001-0020 vía el runner TS (2 pasadas, la 2ª es no-op)", async () => {
  ...
  it("un kind de 0004 (missing_url) es rechazado tras el rollback completo, y el diff de public sigue vacío", async () => {
    ...
    expect(result.reverted).toEqual([
      "0020_curation_durable_decisions", "0019_curation_scan_resolution", "0018_curation_finding_fixes", "0017_curation_findings", "0016_person_duplicate_pair_uk", "0015_review_kind_person_duplicate",
